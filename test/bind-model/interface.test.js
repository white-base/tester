...
// gobal defined
'use strict';
const {IBindCommand}        = require('logic-bind-model')
const {IBindModel}          = require('logic-bind-model')
const {IBind}               = require('logic-bind-model')
const {ICommandCallback}    = require('logic-bind-model')
const {IModelCallback}      = require('logic-bind-model')
const {IAjaxService}        = require('logic-bind-model')
const {IService}            = require('logic-bind-model')
